...
* [Beanstalk - Developing and Deploying with Branches](http://guides.beanstalkapp.com/version-control/branching-best-practices.html)
...
* [Michel Ernest - Version control concepts and best practices](https://homes.cs.washington.edu/~mernst/advice/version-control.html)

* [MS Developer Blog - What is a Cherry Pick Merge, and why do you recommend against them?](https://blogs.msdn.microsoft.com/billheys/2011/01/19/what-is-a-cherry-pick-merge-and-why-do-you-recommend-against-them/)
